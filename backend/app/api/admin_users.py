...
# Layer: Presentation
# Purpose: Admin endpoints for enterprise user account create / list /
#          permanent delete.
# Responsibilities:
#   - GET  /admin/users
#   - POST /admin/users
...
# Dependencies:
#   - require_any_workspace_admin, AdminUserService, get_db_session
# Public Exports:
#   - router
...
#   - Authorization: workspace admin of ≥1 workspace (no global admin role).
# =============================================================================
...
@router.get(
    ...
    summary="List users visible to the calling workspace admin",
...
async def list_admin_users(
    current_user: CurrentUser = Depends(require_any_workspace_admin),
