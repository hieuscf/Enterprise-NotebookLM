...
export function AdminSidebar({ active, user, mobileOpen, onClose }: Props) {
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex h-svh w-64 shrink-0 flex-col overflow-hidden border-r border-border-default bg-surface",
          "transition-transform duration-200 md:static md:h-full md:translate-x-0",
      ...
      >
        ...
        <nav aria-label="Admin Console" className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 py-4">
